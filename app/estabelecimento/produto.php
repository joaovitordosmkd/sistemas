					...
					<div class="row">
									...
									<div class="col-md-12">
										...
										<div id="carouselgaleria" class="carousel slide">
											...
											<div class="carousel-inner">
                                                ...
                                                .list-inline-item {
                                                    flex: 1 0 30%; /* Ocupa até 30% da linha */
						...
						<script>
    						$(document).ready(function() {
                                $('#carouselgaleria').on('slid.bs.carousel', function () {
                                    $('.thumbnail-gallery.active').removeClass('active');
                                });
                            });
						</script>
...
<?php if ($valor_final > '0.00') { ?>
    <div class="row">
        <div class="col-md-12">
            ...
            <!-- Preço anterior (se houver oferta) -->
            <?php if ($data_content['oferta'] == "1") { ?>
                <div class="valor_anterior" style="font-size: 14px; color: #999;">
                    De: <strike><?php echo dinheiro($data_content['valor'], "BR"); ?></strike>
                </div>
            <?php } ?>

            <!-- Preço promocional ou normal -->
            <div class="valor" style="font-size: 18px; font-weight: bold; color: #e74c3c;">
                Por apenas <span>R$ <?php echo dinheiro($valor_final, "BR"); ?></span>
            </div>

            <!-- Total -->
           <!-- <div class="valor_total" style="font-size: 16px; font-weight: bold; color: #333;">
                Total: R$ <?php echo dinheiro($valor_final, "BR"); ?>
            </div>-->
        </div>
    </div>
<?php } ?>
								...
								<!--		<div class="row">
											...
											<div class="col-md-10 col-sm-10 col-xs-10" style="max-width: 320px; margin-bottom: 10px;">
												<a href="https://wa.me/<?php echo clean_str(htmlclean($app['contato_whatsapp'])); ?>?text=<?php echo urlencode('*Estou em dúvida sobre esse produto:* ' . $pegaurl); ?>" target="_blank">
            										...
            										<div class="line quantidade">
            											<div class="row">
            												<div class="col-md-3 col-sm-2 col-xs-2">
            													<span class="thelabel hidden-xs hidden-sm">Em Estoque:</span>
            													<span class="thelabel visible-xs visible-sm">Em Estoque:</span>
            												</div>
            												<div class="col-md-9 col-sm-10 col-xs-10">
            													<div class="campo-numero pull-right">
            														<div id="em-estoque" style="font-size: 18px; margin-right:55px; font-weight: 600;"><?php echo $data_content['posicao'] ?></div>
            													</div>
            												</div>
            											</div>
            										</div>
								    ...
								    <?php if( verifica_horario($app['id']) == "disabled" ) { ?>
								        ...
								        <?php if ( data_info( "estabelecimentos", $app['id'], "funcionamento") == "1" ) { ?>
            								...
            								<div class="comprar">
													...
													<div class="line botoes subtotal-adicionar" style="position: fixed; bottom: 0; left: 0; width: 100%; background-color: #fff; box-shadow: 0 -2px 5px rgba(0, 0, 0, 0.1); padding: 5px 10px; z-index: 999;">
    <div class="row" style="display: flex; justify-content: space-between; align-items: center; max-width: 500px; margin: 0 auto;">
        <div class="col-md-6" style="flex: 1; text-align: left;">
            <div class="subtotal" style="font-size: 14px; font-weight: bold;">
                <strong>Valor:</strong>
                <span>R$ <?php echo dinheiro($data_content['valor_promocional'], "BR"); ?></span>
            </div>
        </div>
        <div class="col-md-6" style="flex: 1; text-align: right;">
            <span class="sacola-adicionar botao-acao" style="padding: 5px 10px; border-radius: 5px; display: inline-flex; align-items: center; cursor: pointer; font-size: 14px;">
                <i class="icone icone-sacola" style="margin-right: 5px;"></i> Comprar
            </span>
        </div>
    </div>
</div>
